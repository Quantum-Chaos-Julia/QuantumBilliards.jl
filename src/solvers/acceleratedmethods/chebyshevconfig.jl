...
"""
    ChebyshevConfig(::Type{T} = Float64; n_panels_h::Int = 15000, M_h::Int = 5, n_panels_j::Int = 10000, M_j::Int = 5, tol::Real = 1e-12, max_iter::Int = 20, sampling_points::Int = 10_000, grow_panels::Real = 1.5, grow_M::Int = 2, param_strategy::Symbol = :global) where {T<:Real} → cfg::ChebyshevConfig
...
* `tol::Real = 1e-12`: Target absolute error for auto-tuning.
* `max_iter::Int = 20`: Maximum auto-tuning iterations.
* `sampling_points::Int = 10_000`: Radial validation points used during auto-tuning.
...
"""
function ChebyshevConfig(::Type{T}=Float64; n_panels_h::Int=15000, M_h::Int=5, n_panels_j::Int=10000, M_j::Int=5, tol::Real=1e-12, max_iter::Int=20, sampling_points::Int=10_000, grow_panels::Real=1.5, grow_M::Int=2, param_strategy::Symbol=:global) where {T<:Real}
